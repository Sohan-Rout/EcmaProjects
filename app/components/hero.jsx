...
const Hero = () => {
  return (
    <section className="bg-black text-white relative overflow-hidden min-h-screen flex flex-col justify-center items-center">
      {/* Gradient overlay */}
      ...
      {/* Container */}
      <div className="container mx-auto px-6 py-10 md:py-16 relative z-10 text-center">
        ...
        <div className="mt-16 flex flex-wrap justify-center gap-8 text-gray-400">
          ...
          <div className="text-center">
            <div className="text-3xl font-bold text-white font-mono">1K+</div>
