      ...
      <style jsx>{`
        ...
        .group:hover .snake-border {
          ...
          .card {
            ...
            height: 540px; /* increased card height for description */
            ...
            {teammates.map((teammate) => (
              ...
              >
                <img
                  ...
                  className=""
                />
                <p className="founder-name" style={teammate.name === "Vinay Singh Shekhawat" ? { fontSize: "1.25rem", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } : {}}>
                  {teammate.name}
                </p>
